...
object Credits {
	...
	val list: List<Pair<String, String>> = listOf(
			...
			"databasing" to "ahemtoday, GuardedLolz, TieSoul, Huebird, ArendAlphaEagle, Armodillomatt12, Eggman199, chrislo27",
...
[RAINBOW]Français (French)[]: Gabgab2222, Pengu12345, Lovestep, Dragoneteur, chrislo27""",
			"sfx" to "F Yeah, Rhythm Heaven! Tumblr, ahemtoday, Haydorf, megaminerzero, Chocolate2890, Whistler_420, TieSoul, Huebird of Happiness, GuardedLolz, TheRhythmKid, Kana, GlitchyPSIX, Mariofan5000, Miracle22",
