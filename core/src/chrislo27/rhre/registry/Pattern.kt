...
data class Pattern(val id: String, val gameID: String, val name: String, val isStretchable: Boolean = false, val cues: List<PatternCue>,
	...
	data class PatternCue(val id: String, val gameID: String, val beat: Float, val track: Int, val duration: Float, val semitone: Int) {
