...
object Credits {
    ...
    private val sfxCreditsFallback: String = listOf("Lvl100Feraligatr", "Draster", "NP", "Eggman199", "WaluigiTime64", "baguette", "Huebird", "Miracle22", "Mariofan5000", "The Golden Station", "GuardedLolz", "GlitchyPSIX", "sp00pster", "Maxanum").joinToString(separator = ", ")
    ...
    fun generateList(): List<Credit> {
        return listOf(
                ...
                "specialThanks" crediting "baguette, GlitchyPSIX, Miracle22, Pengu123, TheRhythmKid, TheGarnet_, " +
                        ...
                        "Rabbidking, Fringession, minenice55, Chillius, Mezian, EBPB2K, GinoTitan, bin5s5, RHModding and Custom Remix Tourney Discord servers",
                "resources" crediting
