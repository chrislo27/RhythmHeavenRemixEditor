...
fun Editor.renderBackground(batch: SpriteBatch, shapeRenderer: ShapeRenderer, camera: OrthographicCamera, updateDelta: Boolean, disableThemeUsesMenu: Boolean = false) {
